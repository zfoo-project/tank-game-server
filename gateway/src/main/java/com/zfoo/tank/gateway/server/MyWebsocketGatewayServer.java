 ...
 * @author godotg
 */
public class MyWebsocketGatewayServer extends AbstractServer<SocketChannel> {


    public MyWebsocketGatewayServer(HostAndPort host) {
        super(host);
    }
    ...
    protected void initChannel(SocketChannel channel) {
        ...
        channel.pipeline().addLast(new MyGatewayRouteHandler());
    }
}
